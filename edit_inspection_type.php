...
<head>
    ...
    <title>Edit Inspection | Planned Maintenance System</title>
...
<div class="container py-4">
    <h5 class="text-center mb-4">Edit Inspection for Equipment</h5>
    <main class="edit-inspection-type-container">
        <form action="update_inspection_type.php" method="post" class="bg-white p-4 rounded shadow-sm">
            ...
            <div class="mb-3">
                <label for="inspectionInterval" class="form-label">Inspection Interval</label>
            ...
            <div class="d-flex gap-2 mt-3">
                <button class="btn btn-success" type="submit" name="updateInspectionType">Update Inspection Type</button>
                <a href="edit_equipment.php?id=<?php echo $equipment_id; ?>" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </main>
</div>
