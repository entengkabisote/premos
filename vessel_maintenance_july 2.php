...
<body>
    ...
    <main class="container-fluid py-4">
        ...
        <div class="row g-4 vessel-maintenance-container">

            <!-- Vessel Image & Cards -->
            <div class="col-lg-6">
                <div class="vessel-image mb-3">
                    <img src="<?php echo $row['imahe']; ?>" alt="Vessel Image" class="img-fluid rounded shadow w-100">
                </div>
            ...
            <div class="d-flex gap-2 mb-4">
                ...
                <?php if (in_array($_SESSION['role'], ['admin', 'superuser', 'user'])): ?>
            ...
            <div class="col-lg-6 vessel-details">
            <table class="table table-bordered table-striped align-middle">
                ...
                <tr>
                    ...
                    <td>
                    <input class="form-check-input" type="checkbox" <?php if ($row['ISPS_compliance'] == 1) echo 'checked'; ?> disabled>
                    </td>
                </tr>
                <tr>
                    <td><strong>ISO 9001:2015</strong></td>
                    <td>
                    <input class="form-check-input" type="checkbox" <?php if ($row['ISO_9001_2015'] == 1) echo 'checked'; ?> disabled>
                    </td>
                </tr>
                <tr>
