            ...
            <form action="add_equipment_rh.php" method="POST">
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input id="equipment_name" name="equipment_name" type="text" class="form-control" required>
                    </div>
                    <div class="col-md-6">
            ...
            <table class="table table-bordered table-striped table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit_equipment_rh.php?id=<?= $equipment['equipment_name_id'] ?>" class="btn btn-sm btn-outline-primary"><i class="fa fa-edit"></i></a>
                            <a href="delete_equipment_rh.php?id=<?= $equipment['equipment_name_id'] ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Are you sure you want to delete this?');"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
