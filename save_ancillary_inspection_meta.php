...
$isDuplicate = false;
$sql = "SELECT * FROM inspection_ancillary WHERE equipment_id = ? AND inspection_type = ?";
...
foreach ($inspection_data as $data) {
    ...
    $sql_insert = "INSERT INTO inspection_ancillary (equipment_id, inspection_type, inspection_interval, person_in_charge, criticality) VALUES (?, ?, ?, ?, ?)";
...
$sql_fetch = "SELECT * FROM inspection_ancillary WHERE equipment_id = ?";
